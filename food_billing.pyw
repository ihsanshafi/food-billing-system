...
Tops.pack(side=TOP)
#Label
lblTitle=Label(Tops,font=('arial',60,'bold'),text='Tortilla Food Billing System',bd=21,bg='black',
...
def CostofItem():
    ...
    PriceofDrinks =(Item1 * 10) + (Item2 * 25) + (Item3 * 7) + (Item4 * 15) + (Item5 * 15) + (Item6 * 10) + (Item7 * 30) + (Item8 * 15)

    PriceofFood =(Item9 * 110) + (Item10 * 120) + (Item11 * 55) + (Item12 * 50) + (Item13 * 70) + (Item14 * 30) + (Item15 * 110) + (Item16 * 110)



    DrinksPrice = "Birr",str('%.2f'%(PriceofDrinks))
    FoodPrice =  "Birr",str('%.2f'%(PriceofFood))
    CostofFood.set(FoodPrice)
    CostofDrinks.set(DrinksPrice)
    SC = "Birr",str('%.2f'%(0.2))
    ServiceCharge.set(SC)

    SubTotalofITEMS = "Birr",str('%.2f'%(PriceofDrinks + PriceofFood ))
    SubTotal.set(SubTotalofITEMS)

    Tax = "Birr",str('%.2f'%((PriceofDrinks + PriceofFood )* 0.15))
    PaidTax.set(Tax)

    TT=((PriceofDrinks + PriceofFood + 0.2) * 0.15)
    TC="Birr",str('%.2f'%(PriceofDrinks + PriceofFood + 0.2 + TT))
    TotalCost.set(TC)
...
def Receipt():
    ...
    txtReceipt.insert(END,'Hot choclate:\t\t\t\t\t'+ E_Pepsi.get()+'\n')
    txtReceipt.insert(END,'Tea:\t\t\t\t\t'+ E_DietCoke.get()+'\n')
    txtReceipt.insert(END,'Juice:\t\t\t\t\t'+ E_Mojito.get()+'\n')
    txtReceipt.insert(END,'Cappuccino:\t\t\t\t\t'+ E_Cappuccino.get()+'\n')
    txtReceipt.insert(END,'Water:\t\t\t\t\t'+ E_Fanta.get()+'\n')
    txtReceipt.insert(END,'Milk Shake:\t\t\t\t\t'+ E_CocaCola.get()+'\n')
    txtReceipt.insert(END,'Coffee:\t\t\t\t\t'+ E_ColdCoffee.get()+'\n')
    txtReceipt.insert(END,'Pizza:\t\t\t\t\t'+ E_HotDog.get()+'\n')
    txtReceipt.insert(END,'Las:\t\t\t\t\t'+ E_VegBurger.get()+'\n')
    txtReceipt.insert(END,'Taco:\t\t\t\t\t'+ E_Pasta.get()+'\n')
    txtReceipt.insert(END,'Burrito:\t\t\t\t\t'+ E_HamBurger.get()+'\n')
    txtReceipt.insert(END,'Salad:\t\t\t\t\t'+ E_Sandwich.get()+'\n')
    txtReceipt.insert(END,'Fries:\t\t\t\t\t'+ E_Fires.get()+'\n')
    txtReceipt.insert(END,'Spagetti:\t\t\t\t\t'+ E_Spagetti.get()+'\n')
    txtReceipt.insert(END,'Chicken Fazitas:\t\t\t\t\t'+ E_Fazitas.get()+'\n')
    txtReceipt.insert(END,'\t\t\t\t\t\t\t\tcost of items\n')
...
#########################################Drinks####################################################################
Sprite=Checkbutton(Drinks_F,text='Soda              "10 Birr"',variable=var1,onvalue=1,offvalue=0,font=('arial',18,'bold'),
                    bg='orange',command=chkSprite).grid(row=0,sticky=W)
Pepsi=Checkbutton(Drinks_F,text='Hot Choclate "25 Birr"',variable=var2,onvalue=1,offvalue=0,font=('arial',18,'bold'),
                    bg='orange',command=chkPepsi).grid(row=1,sticky=W)
DietCoke=Checkbutton(Drinks_F,text='Tea                  "7 Birr"',variable=var3,onvalue=1,offvalue=0,font=('arial',18,'bold'),
                    bg='orange',command=chk_DietCoke).grid(row=2,sticky=W)
Mojito=Checkbutton(Drinks_F,text='Juice              "15 Birr"',variable=var4,onvalue=1,offvalue=0,font=('arial',18,'bold'),
                    bg='orange',command=chk_Mojito).grid(row=3,sticky=W)
Cappuccino=Checkbutton(Drinks_F,text='Cappuccino   "15 Birr"',variable=var5,onvalue=1,offvalue=0,font=('arial',18,'bold'),
                    bg='orange',command=chk_Cappuccino).grid(row=4,sticky=W)
Fanta=Checkbutton(Drinks_F,text='Water 500ml   "10 Birr"',variable=var6,onvalue=1,offvalue=0,font=('arial',18,'bold'),
                    bg='orange',command=chk_Fanta).grid(row=5,sticky=W)
CocaCola=Checkbutton(Drinks_F,text='Milk Shake      "30 Birr"',variable=var7,onvalue=1,offvalue=0,font=('arial',18,'bold'),
                    bg='orange',command=chk_CocaCola).grid(row=6,sticky=W)
ColdCoffee=Checkbutton(Drinks_F,text='Coffee             "15 Birr"',variable=var8,onvalue=1,offvalue=0,font=('arial',18,'bold'),
...
HotDog = Checkbutton(Food_F,text='Pizza                   "110 Birr" ',variable=var9,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='orange',command=chk_HotDog).grid(row=0,sticky=W)
VegBurger = Checkbutton(Food_F,text='Lasagna             "120 Birr"',variable=var10,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='orange',command=chk_VegBurger).grid(row=1,sticky=W)
Pasta = Checkbutton(Food_F,text='Taco                     "55 Birr"',variable=var11,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='orange',command=chk_Pasta).grid(row=2,sticky=W)
HamBurger = Checkbutton(Food_F,text='Burrito                  "50 Birr"',variable=var12,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='orange',command=chk_HamBurger).grid(row=3,sticky=W)
Sandwich = Checkbutton(Food_F,text='Salad                    "70 Birr"',variable=var13,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='orange',command=chk_Sandwich).grid(row=4,sticky=W)
Fires = Checkbutton(Food_F,text='Tortilla                  "30 Birr"',variable=var14,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='orange',command=chk_Fires).grid(row=5,sticky=W)
Spagetti = Checkbutton(Food_F,text='Spagetti              "110 Birr"',variable=var15,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='orange',command=chk_Spagetti).grid(row=6,sticky=W)
Fazitas = Checkbutton(Food_F,text='Chicken Fazitas "110 Birr"',variable=var16,onvalue = 1, offvalue=0,
...
lblServiceCharge=Label(Cost_F,font=('arial',14,'bold'),text='\t2% S.Charge',bg='orange',
                fg='black',justify=CENTER)
lblServiceCharge.grid(row=1,column=2,sticky=W)
txtServiceCharge=Entry(Cost_F,bg='white',bd=7,font=('arial',14,'bold'),
                        insertwidth=2,justify=RIGHT,textvariable=ServiceCharge)
txtServiceCharge.grid(row=1,column=3)
###########################################################Payment information###################################################

lblPaidTax=Label(Cost_F,font=('arial',14,'bold'),text='\t 15% VAT',bg='orange',bd=7,
                fg='black',justify=CENTER)
...
btn0=Button(Cal_F,padx=16,pady=1,bd=7,fg='black',font=('arial',16,'bold'),width=4,text='0',
                        bg='orange',command=lambda:btnClick(0)).grid(row=5,column=1)
btnClear=Button(Cal_F,padx=16,pady=1,bd=7,fg='black',font=('arial',16,'bold'),width=4,text='C',
                        bg='orange',command=btnClear).grid(row=5,column=0)
